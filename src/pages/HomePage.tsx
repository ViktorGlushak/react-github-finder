...
const HomePage = () => {
  ...
  const [debounce, setDebounced] = useDebounce(search)
    ...
    <div className="flex justify-center pt-10 mx-auto h-screen w-screen">
      ...
      <div className="relative w-[560px] ">
        ...
        {dropdown && <ul className="list-none absolute top-[42px] left-0 right-0 max-h-[200px] shadow-md bg-white overflow-y-scroll">
         { isLoading && <p className="text-center text-gray-700">Загрузка ... </p>}
          { data?.map(user => (
            <li
              key={user.id}
        ...
        {areReposLoading && <p className="text-center">Repos загружаются ... </p>}
